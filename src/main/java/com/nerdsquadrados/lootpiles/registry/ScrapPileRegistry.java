...
public final class ScrapPileRegistry {
    ...
    public static void bootstrap() {
        ...
        if (BY_ID.isEmpty()) {
            LootPiles.LOGGER.error("No scrap pile definitions were loaded from config/lootpiles/scrap_piles/");
        } else {
    ...
    public static Component createDisplayName(ScrapPileDefinition definition) {
        return Component.literal(definition.displayType() + " Scrap Pile")
                .withStyle(Style.EMPTY.withColor(definition.tintColor()).withBold(true));
    }
